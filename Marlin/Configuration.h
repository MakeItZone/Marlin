...
#define STRING_CONFIG_H_AUTHOR "(Julian Rendell, MakeItZone JGAurora A3 config)" // Who made the changes.
...
// #define SHOW_CUSTOM_BOOTSCREEN // REMEMBER A3 has a text screen, not graphical!
...
#define CUSTOM_MACHINE_NAME "MakeItZone - JGAurora A3"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "e8d782b5-69b8-4490-9f4e-e72447672bae"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // JG Aurora A3 - autotuned at 200C
  #define DEFAULT_Kp 31.91 
  #define DEFAULT_Ki 2.31
  #define DEFAULT_Kd 110.46
